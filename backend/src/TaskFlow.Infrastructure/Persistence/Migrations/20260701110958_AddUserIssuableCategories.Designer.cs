...
namespace TaskFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260701110958_AddUserIssuableCategories")]
    partial class AddUserIssuableCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.UserIssuableCategory", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserIssuableCategories");
                });
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.UserIssuableCategory", b =>
                {
                    b.HasOne("TaskFlow.Domain.Entities.TicketCategory", "Category")
                        .WithMany("IssuableByUsers")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskFlow.Domain.Entities.User", "User")
                        .WithMany("IssuableCategories")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("IssuableCategories");
